...
export const DEFAULT_SETTINGS: TeacherPlannerSettings = {
  ...
  activities: [
    ...
    { id: "activity-meeting",   label: "Meeting",        colour: "#4a90d9", activityType: "directed" as const, durationMinutes: 60 },
    { id: "activity-protected", label: "Protected time", colour: "#9070cc", activityType: "directed" as const },
    { id: "activity-tutor",     label: "Tutor",          colour: "#f0956a", activityType: "directed" as const, durationMinutes: 30 },
  ],
  dateEvents: [],
  slotExclusions: [],
  weekNotes: {},
