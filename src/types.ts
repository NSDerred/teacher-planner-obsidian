...
export interface TeacherPlannerSettings {
  ...
  /** Lesson overview: whether the class tiles / overview panel are expanded. */
  loClassesOpen?: boolean;
  loStatsOpen?: boolean;
  ...
  /** Id of the default lesson-note template: a built-in id or a user-template file path. */
